...
import { ActionType, HighlightAttrs, HighlightOptions, HighlightPluginState } from './types';
...
export class HighlightExtension extends MarkExtension<HighlightOptions> {
  get name(): string {
